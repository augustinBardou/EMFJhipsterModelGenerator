...
public class ModelDescription
{
  ...
  protected final String TEXT_2 = NL + NL + "This model description is not a real EMF artifact. It was generated by the" + NL + "org.eclipse.emf.gencode.jhipster plug-in to illustrate how EMF's" + NL + "code generator can be extended." + NL + "This can be disabled with -vmargs -Dorg.eclipse.emf.examples.generator.validator=false." + NL;
